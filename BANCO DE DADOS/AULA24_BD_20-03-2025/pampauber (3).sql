...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 20, 2025 at 04:03 PM
...
INSERT INTO `mecanico` (`id_mecanico`, `nome_completo`, `endereco`, `cidade`, `estado`, `cpf`, `celular`) VALUES
(1, 'Lucas Ferreira', 'Rua das Oficinas, 100', 'Curitiba', 'PR', 123456, 0),
(2, 'Paulo Mendes', 'Av. Principal, 500', 'Belo Horiz', 'MG', 987654, 0);
